						...
						<form class="content">
							<div class="row">
								...
								<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
									...
									<a href="#" class="btn btn-blue btn-lg full-width">Submit</a>
								</div>
							</div>
						</form>
					</div>
						...
						<form class="content">
							<div class="row">
								<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
									...
									<a href="#" class="btn btn-lg bg-facebookB full-width btn-icon-left"><i class="fab fa-facebook-f" aria-hidden="true"></i>Login with Facebook</a>
