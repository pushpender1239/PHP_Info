...
<div class="fixed-sidebar">
  <div class="fixed-sidebar-left sidebar--small" id="sidebar-left"> <a href="02-ProfilePage.html" class="logo">
    <div class="img-wrap"> <img src="http://localhost/project/img/logo.png" alt="eGyanshala"> </div>
    </a>
  ...
  <!-- <a href="login-register.php" class="logo"> -->
  <a href="<?php echo site_url('loginRegister/index') ?>" class="logo">
