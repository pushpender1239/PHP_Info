			...
			<div class="registration-login-form">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="home" role="tabpanel" data-mh="log-tab">
						<div class="title h6">Otp verification</div>
						<form class="content">
							<div class="row">
								...
								<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <span class="text-center">Did'nt receive otp?
			
										<a href="#" class="forgot">Resend Otp</a></span>
                                        
									<a href="#" class="btn btn-blue btn-lg full-width" style="margin-top:20px;">Submit</a>
								</div>
							</div>
						</form>
					</div>
